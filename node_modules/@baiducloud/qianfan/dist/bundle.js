(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('process'), require('events'), require('url'), require('tty'), require('util'), require('os'), require('await-mutex'), require('fs'), require('path'), require('crypto'), require('bottleneck')) :
  typeof define === 'function' && define.amd ? define(['exports', 'process', 'events', 'url', 'tty', 'util', 'os', 'await-mutex', 'fs', 'path', 'crypto', 'bottleneck'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MyLibrary = {}, global.process$1, global.events, global.url, global.require$$1, global.util, global.require$$0, global.Mutex, global.require$$0$1, global.require$$1$1, global.require$$3, global.Bottleneck));
})(this, (function (exports, process$1, events, url, require$$1, util, require$$0, Mutex, require$$0$1, require$$1$1, require$$3, Bottleneck) { 'use strict';
  ...
  var Stream = /*#__PURE__*/function (_EventEmitter, _Symbol$asyncIterator) {
    ...
    return Stream;
  }(events.EventEmitter, Symbol.asyncIterator);
    ...
    _createClass(HttpClient, [{
      ...
      value: (function () {
        var _getSignature = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
          var httpMethod, path, body, headers, params, signFunction, method, requestUrl, _headers, contentLength, url$1, options, reqHeaders, fetchOptions;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                url$1 = new url.URL(requestUrl);
                _headers[HOST] = url$1.host;
                options = urlObjectToPlainObject(url$1, method, _headers);
                _context.next = 10;
  ...
  exports.Embedding = Eembedding;
  exports.Image2Text = Image2Text;
